...
class Mediagraph_Picker {
    ...
    public function enqueue_block_editor_assets() {
        ...
        // Enqueue the block extension (adds Mediagraph button to Image, Gallery, Cover, Media & Text toolbars)
        wp_enqueue_script(
            'mediagraph-image-extension',
            MEDIAGRAPH_PICKER_PLUGIN_URL . 'admin/js/gutenberg-image-extension.js',
            array( 'wp-hooks', 'wp-compose', 'wp-element', 'wp-block-editor', 'wp-components', 'wp-blocks', 'wp-data' ),
            MEDIAGRAPH_PICKER_VERSION,
            true
        );
